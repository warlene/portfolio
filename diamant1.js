jQuery(document).ready(function(){
    var draw = SVG('diamant1').size(300, 200).viewbox(0, 0, 400, 400)
    ...
    $('#diamant1').append("<h2>javascript</h2>")


    var draw = SVG('diamant2').size(300, 200).viewbox(0, 0, 400, 400)
    ...
    $('#diamant2').append("<h2>php</h2>")

    var draw = SVG('diamant3').size(300, 200).viewbox(0, 0, 400, 400)
    ...
    $('#diamant3').append("<h2>HTML5</h2>")

    var draw = SVG('diamant4').size(300, 200).viewbox(0, 0, 400, 400)
    ...
    $('#diamant4').append("<h2>CSS / SASS</h2>")
});
